# -*- coding: utf-8 -*-
"""Importador simples do banco antigo (banco_antigo/clinica.db) para o Eduarda Imbelloni.

Uso:
    python tools/import_legacy_hellen.py "caminho/para/clinica_antiga.db"
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Uso: python tools/import_legacy_hellen.py caminho/para/clinica_antiga.db")
        raise SystemExit(2)
